...
class LogSystem<T extends ILog & Comparable<T>> {
    ...
    void printResults() {
        ...
        LogProcessor<T> firstLogProcessor = logsList -> logsList.stream().filter(l->l.getType().equals("INFO")).collect(Collectors.toCollection(ArrayList::new));
        ...
        LogProcessor<T> thirdLogProcessor = logsList -> logsList.stream().sorted().collect(Collectors.toCollection(ArrayList::new));
