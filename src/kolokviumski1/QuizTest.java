...
//        if (parts[0].equals("MC")&&!parts[3].equals("A")&&!parts[3].equals("B")&&!parts[3].equals("C")&&!parts[3].equals("D")&&!parts[3].equals("E"))
//            throw new InvalidOperationException(String.format("%s is not allowed option for this question",parts[3]));
//        questions.add(new Question(parts[0],parts[1],Integer.parseInt(parts[2]),parts[3]));
//    }
...
//            }
//            else if (questions.get(i).getType().equals("TF")){
